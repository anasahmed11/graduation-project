        ...
        <div class="row">
            ...
            <div class="col-md-7 offset-1 wow fadeInDown"data-wow-duration="2s" data-wow-offset="300">
                ...
                <div class="home-img img-ajx">
                    <img src="{{url('/uploads/person-woman-apple-hotel.jpg')}}"  width="100%" class="img-responsive"
                ...
                <div class="h-desc desc desc-ajx wow fadeInUp"data-wow-duration="2s" data-wow-offset="300">
                    ...
                    <p>
                        ...
                        # we provide some of topics written by experts in psychology , this topics help you to know what do
                        you need from your
                        doctor
                        <br><br>
